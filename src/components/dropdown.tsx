...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ref={ref}
        className={clsx(
            'flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm text-black/80 outline-none transition-colors hover:text-black focus:bg-black/10 focus:text-black data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:text-white/80 dark:focus:bg-white/10 dark:focus:text-white',
            inset && 'pl-8',
            className
        )}
        {...props}
